...
public:
    ...
    Reflective_Shader(Render_World& world_input, const Vector_3D<double>& color_ambient, const Vector_3D<double>& color_diffuse, const Vector_3D<double>& color_specular=Vector_3D<double>(1,1,1), const double specular_power=50, const double reflectivity=1)
        :   Phong_Shader(world_input,color_ambient,color_diffuse,color_specular,specular_power)
